                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="${pageContext.request.contextPath}/habitaciones.do?op=listar">
                                <div class="panel-footer">
                                    <span class="pull-left">Ver habitaciones</span>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <!-- <div class="huge">10</div>-->
                                        <div><h4>Reservas</h4></div>
                                    </div>
                                </div>
                            </div>
                            <a href="${pageContext.request.contextPath}/reservas.do?op=listarReservasAdmin">
                                <div class="panel-footer">
                                    <span class="pull-left">Ver reservas</span>
                                    <span class="pull-right"><i class="glyphicon glyphicon-arrow-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <!-- <div class="huge">10</div> -->
                                        <div><h4>Sugerencias</h4></div>
                                    </div>
                                </div>
                            </div>
                            <a href="${pageContext.request.contextPath}/contactos.do?op=listar">
                                <div class="panel-footer">
                                    <span class="pull-left">Ver sugerencias recibidas</span>
                                    <span class="pull-right"><i class="glyphicon glyphicon-arrow-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
