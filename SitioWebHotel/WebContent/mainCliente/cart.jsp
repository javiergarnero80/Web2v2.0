...
<body>
	...
	<section id="cart_items">
		<div class="container">
					...
					%>
						<tr>
							<td class="cart_product">
								<a href=""><img src="${pageContext.request.contextPath}/mainCliente/images/shop/<%=hc.getImagen()%>" height="80" width="110" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href=""><%=hc.getTipo() %></a></h4>
								<p>ID:<%=hc.getNumeroHabitacion()%></p>
							</td>
							<td class="cart_price">
								<p>$<%=Math.round(hc.getCostoDiario())*100.00/100.00%></p>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price">$<%=Math.round(hc.getCostoDiario()*hc.getCantidadDias()*100)/100.0 %></p>
							</td>
							<td class="cart_delete">
								<span id="numeroHabitacion" style="display: none;"><%=hc.getNumeroHabitacion()%></span>
			...
			<p><i><a href="../carrito.do?op=listarHabCarrito">Volver a lista de habitaciones y servicios</a></i></p>
		</div>

	</section> <!--/#cart_items-->
	<br><br>
	<input type="hidden" id="permiso" value="<%=Math.round(total*100.0)/100.0 %>">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="total_area">
						...
						<form id="checkout" action="${pageContext.request.contextPath}/carrito.do" method="post">
						...
						<button onclick="javascript:sendForm();" class="btn btn-default check_out" title="Continuar">Ir a Check Out</button>
					</div>
				</div>
			</div>
		</div>
    ...
    <script src="${pageContext.request.contextPath}/mainCliente/js/carrito.js"></script>
