...
<head>
	...
	<link href="${pageContext.request.contextPath}/mainCliente/css/bootstrap-datepicker3.min.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-6">
							<div class="view-product">
								<img src="mainCliente/images/shop/${detalleHabitacion.imagen}" style="width:390px;height:300px;" alt=""/>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="product-information"><!--/product-information-->
								<h2>${detalleHabitacion.descripcion}</h2>
								<p><b>Numero Habitacion:</b> ${detalleHabitacion.numeroHabitacion}</p>
								<p><b>Disponible para Reserva:</b> Si</p>
								
								<form id="detalle" action="${pageContext.request.contextPath}/carrito.do?op=agregarCarrito" method="post">
									<input type="hidden" value="${detalleHabitacion.numeroHabitacion}" name="numeroHabitacion">
									<input type="hidden" value="${detalleHabitacion.descripcion}" name="descripcion">
									<input type="hidden" value="${detalleHabitacion.tipo}" name="tipo">
									<input type="hidden" value="${detalleHabitacion.costoDiario}" name="costoDiario">
									<input type="hidden" value="${detalleHabitacion.imagen}" name="imagen">
									<!-- calendario -->
									<div id="sandbox-container">
										<div class="input-daterange input-group" id="datepicker">
											<span class="input-group-addon"><b>Fecha de Ingreso</b></span> <input
												type="text" class="input-sm form-control" id="start"
												name="start" readonly /> <span class="input-group-addon"><b>Fecha
												de Salida</b></span> <input type="text" class="input-sm form-control"
												id="end" name="end" readonly />
										</div>
									</div>

									<span> <span>$ ${detalleHabitacion.costoDiario}</span>
										<!--<button type="submit" class="btn btn-fefault cart">
											<i class="fa fa-shopping-cart"></i> Reservar
										</button>-->
									</span>
								</form>
								<button onclick="javascript:sendForm();" class="btn btn-second cart" title="Continuar">Reservar</button>
    ...
    <script src="${pageContext.request.contextPath}/mainCliente/js/jquery.js"></script>
	<script src="${pageContext.request.contextPath}/mainCliente/js/price-range.js"></script>
    <script src="${pageContext.request.contextPath}/mainCliente/js/jquery.scrollUp.min.js"></script>
	<script src="${pageContext.request.contextPath}/mainCliente/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/mainCliente/js/jquery.prettyPhoto.js"></script>
    <script src="${pageContext.request.contextPath}/mainCliente/js/main.js"></script>
    
    <!-- librerias para datepickers -->
    <script src="${pageContext.request.contextPath}/mainCliente/js/bootstrap-datepicker.min.js"></script>
    <script src="${pageContext.request.contextPath}/mainCliente/js/bootstrap-datepicker.es.js" charset="UTF-8"></script>
