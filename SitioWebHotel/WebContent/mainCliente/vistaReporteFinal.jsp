...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<script src="${pageContext.request.contextPath}/mainCliente/js/jspdf.min.js"></script>
	<script src="${pageContext.request.contextPath}/mainCliente/js/html2canvas.js"></script>
    <!--[if lt IE 9]>
...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<h2><b>Reserva hecha en forma exitosa!!!</b><a href="javascript:genPDF()"> Descargar Voucher</a></h2>
			<!--  <p><a href="javascript:window.history.go(-4);">Volver al listado de habitaciones</a></p>-->
			<h4><a href="${pageContext.request.contextPath}/eliminarCarrito.do">Volver al listado de habitaciones</a></h4>
			</div>
