...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<h2><b>Detalle de su reserva</b></h2>
			</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="shopper-info">
							...
							<p>Al confirmar su reserva prodrá ver y descargar el voucher en PDF.</p>
							<form action="carrito.do?op=registrarReserva" method="post">
								<label>Nombre</label><input type="text" name="nombre" value="${cliente.nombre}" placeholder="Display Name" readonly>
								<label>Email para envío del voucher</label><input type="text" name="email" value="${cliente.email}" readonly>
								<input type="hidden" name="idCliente" value="${cliente.idCliente}" >
								<input type="hidden" name="totalGeneralReserva"value="<%=Math.round(total*100.0)/100.0 %>">
