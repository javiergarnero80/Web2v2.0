...
<body>
<form action="https://formspree.io/hotelmyj@gmail.com" method="POST" id="contact-form">
	<h2>Contacto</h2>
	<!-- <input type="text" name="para" placeholder="para..." required> -->
	<!-- <input type="hidden" name="para" value="hotelaydaw2@gmail.com">-->
	
	<input type="hidden" name="_next" value="${pageContext.request.contextPath}/resultado.jsp" />
	<input type="hidden" name="_subject" value="Nuevo Correo de contacto!" />
	<input type="text" name="_gotcha" style="display:none" />
	<input type="hidden" name="_language" value="es" />
	
	<input type="text" id="inputName" name="nombre" placeholder="Ingrese su nombre" required>
...
<div align="center">
	<h5><a style="color:white;" href="inicioHotel.html">Volver a Inicio</a></h5>
</div>
