        ...
        <div class="container">
            ...
            <div class="row">
                <div class=" col-md-7">
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/habitaciones.do" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="1" min="100" max="999" class="form-control" name="numeroHabitacion" id="numeroHabitacion" value="${habitacion.numeroHabitacion}" readonly placeholder="Ingresa el número de habitacuón">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tipo">Tipo de habitación:</label> <!-- debería haber una lista de selección con las opciones -->
                            <div class="input-group">
                               <!--   <input type="text" class="form-control" name="tipo" id="tipo" value="${habitacion.tipo}" placeholder="Ingresa el tipo de habitación" >
                                ...
                                <select name="tipo" id="tipo" class="form-control">
                                	<c:forEach items="${requestScope.listaTiposHabitacion}" var="habitacionTipo">
                            ...
                            <div class="input-group">
                                <!--<input type="text" class="form-control" id="descripcion" name="descripcion" value="${habitacion.descripcion}" placeholder="Ingresa una descripción de la habitación">-->
                                 <select name="descripcion" id="descripcion" class="form-control">
                                	<c:forEach items="${requestScope.listaDescripcionHabitacion}" var="habitacionDesc">
                                		<c:if test="${habitacionDesc.descripcion eq habitacion.descripcion}">
                                			<option selected value="${habitacionDesc.descripcion}">${habitacionDesc.descripcion}</option>
                                		</c:if>
                                		<c:if test="${habitacionDesc.descripcion ne habitacion.descripcion}">
                        ...
                        <div class="form-group">
                            <label for="cantidadPlazas">Cantidad de Plazas de la habitación:</label>
                            <div class="input-group">
                                <input type="number" step="1" min="1" max="5" class="form-control" id="cantidadPlazas" name="cantidadPlazas" value="${habitacion.cantidadPlazas}"  placeholder="Ingresa cantidad de plazas de la habitación " >
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.1" min="1" class="form-control" id="costoDiario" name="costoDiario" value="${habitacion.costoDiario}" placeholder="Ingresa el precio diario de la habitación " >
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-info" value="Guardar" name="Guardar">
                        <a class="btn btn-danger" href="${pageContext.request.contextPath}/habitaciones.do?op=listar">Cancelar</a>
                    </form>
                </div>
            </div>  
        </div>
