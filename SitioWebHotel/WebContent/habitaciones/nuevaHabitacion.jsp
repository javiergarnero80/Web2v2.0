                    ...
                    <form role="form" action="${pageContext.request.contextPath}/habitaciones.do" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="1" min="100" max="999" class="form-control" name="numeroHabitacion" id="numeroHabitacion" value="${habitacion.numeroHabitacion}" placeholder="Ingresa el número de habitacuón" >
