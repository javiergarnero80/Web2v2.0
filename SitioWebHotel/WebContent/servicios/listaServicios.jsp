...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10">
                    <a type="button" class="btn btn-primary btn-md" href="${pageContext.request.contextPath}/servicios.do?op=nuevo"> Nuevo Servicio</a>
                <br><br>
                <table class="table table-striped table-bordered table-hover" id=tabla>
                    ...
                    <tbody>
                    	...
                    	<c:forEach items="${requestScope.listaServicios}" var="servicio"> <!-- recorremos la lista que nos envio el controlador -->
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  class="btn btn-danger" href="javascript:eliminar('${servicio.idServicio}')"><span class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                   		</c:forEach>
                    </tbody>
