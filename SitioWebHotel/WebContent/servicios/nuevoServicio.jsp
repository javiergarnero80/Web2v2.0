        ...
        <div class="container">
            ...
            <div class="row">
                <div class=" col-md-7">
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/servicios.do" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="descripcion" name="descripcion" value="${servicio.descripcion}" placeholder="Ingresa una descripción del servicio">
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.1" min="1" class="form-control" id="precioDiario" name="precioDiario" value="${servicio.precioDiario}" placeholder="Ingresa el precio diario por el servicio " >
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-info" value="Guardar" name="Guardar">
                        <a class="btn btn-danger" href="${pageContext.request.contextPath}/servicios.do?op=listar">Cancelar</a>
                    </form>
                </div>
            </div>  
        </div>
